...
│   │   │   │   ├── source_monitor_service.py # 状态监控
│   │   │   │   ├── data_scheduler.py         # 数据调度
│   │   │   │   ├── market_data_service.py    # 市场数据
│   │   │   │   ├── dual_channel_service.py   # 双通道
│   │   │   │   └── rate_limiter.py           # 限流器
│   │   │   ├── sources/               # 数据源适配器
│   │   │   │   ├── base.py            # 适配器基类
│   │   │   │   ├── registry.py        # 数据源注册表
...
│   │   │   ├── scheduler/             # 工作流调度器（LangChain + asyncio）
│   │   │   │   ├── __init__.py        # 调度器模块导出
...
│   │   │   │   │       └── cro.yaml
│   │   │   │   └── phase4/            # 第四阶段：总结报告
│   │   │   │       ├── runner.py      # run_phase4() 固定流程
│   │   │   │       └── agents/        # 固定 1 个智能体
│   │   │   │           └── summarizer.yaml
│   │   │   ├── pusher/                # WebSocket 推送模块
│   │   │   │   ├── __init__.py        # 推送模块导出
│   │   │   │   ├── manager.py         # WebSocketManager
│   │   │   │   └── events.py          # 事件定义
│   │   │   ├── manager/               # 任务管理模块
│   │   │   │   ├── __init__.py        # 任务管理模块导出
