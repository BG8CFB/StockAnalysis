...
# 创建路由器
router = APIRouter(prefix="/trading-agents/tasks", tags=["TradingAgents - 任务管理"])
...
@config_router.put("", response_model=UserAgentConfigResponse)
...
@config_router.put("/public", response_model=UserAgentConfigResponse)
